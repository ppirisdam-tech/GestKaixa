...
En aquesta versió he fet dos canvis importants respecte a la v1.2:
El primer és que ara cada moviment registra quin usuari l'ha fet. Abans només guardàvem a quina compte s'havia fet l'operació, però no sabíem qui l'havia executat. Ara s'envia el usuari_id de la sessió activa en cada INSERT a Moviments, cosa que fa el sistema completament auditable.
El segon és una nova funcionalitat: el client pot fer una sol·licitud de transferència a un compte extern. Aquesta sol·licitud no s'executa immediatament, sinó que queda en estat PENDENT fins que l'administrador la revisi i decideixi aprovar-la o denegar-la. He hagut de crear una nova taula Solicituds a MySQL per gestionar-ho.



2. Estructura del codi
Continua en un únic fitxer Program.cs, he afegit nous mètodes i reorganitzat el codi per blocs: sessió, menú client, menú administrador, i utilitats compartides.
...
LlistarComptesDropdown(): Mètode reutilitzable: llistat de comptes actius de l'usuari, usat per VeureMovimentsCompte, OperarCompte i ClientSollicitarTransferencia
...
AdminLlistarTot(): Llistat complet de tots els usuaris, comptes i saldos
ClientSollicitarTransferencia(): Nou: crea una sol·licitud de transferència pendent
AdminGestionarSolicituds(): Nou: l'admin pot aprovar o denegar sol·licituds
LeerContrasenyaSegura(): Ocultació del password amb asteriscs


3Explicacio

-Auditoria: camp usuari_id a Moviments
Abans la inserció d'un moviment no incloïa qui l'havia fet:
"INSERT INTO Moviments (compte_id, usuari_id, import, concepte)
VALUES (@cId, @uId, @imp, @conc)"


-He creat manualment a MySQL una taula nova per gestionar les transferències pendents:
...
-El camp estat comença sempre com a PENDENT. Quan l'administrador la gestiona, s'actualitza a APROVADA o DENEGADA amb un UPDATE

-El client selecciona el compte origen, introdueix l'IBAN destí, l'import i el concepte.
S'insereix un registre a Solicituds amb estat PENDENT. No es toca Moviments encara.
L'administrador entra al menú i veu totes les sol·licituds pendents.
Si aprova la sol·licitud, el programa llegeix les dades de Solicituds i executa el INSERT a Moviments (retirada en negatiu). Després fa UPDATE per canviar l'estat a APROVADA.
Si la denega, simplement fa UPDATE a DENEGADA sense tocar Moviments.
...
=== ESTAT ELS MEUS COMPTES ===                                                                                                                                      
ID COMPTE  NÚMERO DE COMPTE          ESTAT                                                                                                                          
------------------------------------------------                                                                                                                    
...
Data/Hora            Concepte                      Import Saldo Resultant                                                                                           
---------------------------------------------------------------------                                                                                               
22/05/2026 07:58     pis                          39,00 €  41.039,00 €                                                                                              
22/05/2026 07:17     casa                      -30.000,00 €  41.000,00 €                                                                                            
22/05/2026 07:17     casa                      70.000,00 €  71.000,00 €                                                                                             
21/05/2026 19:22     Ingrés d’obertura de compte 1.000,00 €   1.000,00 € 


proba de la proba:

=== CONFIGURACIÓ DE RETIRADA ===                                                                                                                                    
 -> ID: 1 | Compte: ES12345678901234567890                                                                                                                          
                                                                                                                                                                    
ID del compte a operar: 1                                                                                                                                           
Quantitat en EUROS (€): 3                                                                                                                                           
Concepte del moviment: pis                                                                                                                                          
...
Data/Hora            Concepte                      Import Saldo Resultant                                                                                           
---------------------------------------------------------------------                                                                                               
22/05/2026 08:01     pis                          -3,00 €  41.036,00 €                                                                                              
22/05/2026 07:58     pis                          39,00 €  41.039,00 €                                                                                              
22/05/2026 07:17     casa                      -30.000,00 €  41.000,00 €                                                                                            
22/05/2026 07:17     casa                      70.000,00 €  71.000,00 €                                                                                             
21/05/2026 19:22     Ingrés d’obertura de compte 1.000,00 €   1.000,00 €                                                                                            
...
=== HISTÒRIC D'ALERTES DE SEGURETAT ===                                                                                                                             
[22/05/2026 07:17] Compte: ES12345678901234567890 -> ALERT: Supera llindar 10000                                                                                    
Menu 6 solicitud " en la qual he creat una taula en mysql on es gestionen"
...
SELECT id, compte_origen_id, compte_desti_iban, usuari_id, import, estat
FROM Solicituds
ORDER BY id DESC LIMIT 1;
+----+------------------+------------------------+-----------+---------+---------+
| id | compte_origen_id | compte_desti_iban       | usuari_id | import  | estat   |
+----+------------------+------------------------+-----------+---------+---------+
|  1 |                1 | ES0000000000000000000002|         1 | 23333.00| PENDENT |
+----+------------------+------------------------+-----------+---------+---------+



SELECT id, compte_id, usuari_id, import, saldo, concepte
FROM Moviments
WHERE concepte = 'pis'
ORDER BY id DESC LIMIT 1;
+----+-----------+-----------+-------+----------+---------+
| id | compte_id | usuari_id | import| saldo    | concepte|
+----+-----------+-----------+-------+----------+---------+
|  5 |         1 |         1 | 39.00 | 41039.00 | pis     |
+----+-----------+-----------+-------+----------+---------+



6. Conclusions
El canvi més important d'aquesta versió no és visible per a l'usuari: ara sabem qui ha fet cada moviment. Qualsevol operació queda lligada a un usuari_id, cosa que permet detectar si algú ha fet moviments en comptes als quals no hauria de tenir accés.

La part més complexa ha estat el flux de les sol·licituds de transferència: he hagut de gestionar dues operacions separades i assegurar-me que si el moviment falla per saldo insuficient, el trigger de la BBDD ho bloqueja i la sol·licitud no canvia d'estat.