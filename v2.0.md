...
Deixar constància que ara el sistema és **auditable** i 100% segur perquè el codi en C# envia l'ID de la sessió del client (`usuari_id`) a la base de dades en cada moviment
